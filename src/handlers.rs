...
pub enum SocketMessage {
    ...
    ClientInventory(ClientInventory::Message),
...
pub enum SocketResponse {
    ...
    ClientInventory(ClientInventory::Response),
...
pub async fn handle(message: SocketMessage, sess: &mut Session) -> Option<SocketResponse> {
    match message {
        ...
        SocketMessage::ClientInventory(msg) => ClientInventory::handle(msg, sess).await,
